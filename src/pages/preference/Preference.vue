          ...
          <q-item-label>
            <span
              >Sensitivity (pixels)<q-tooltip
                anchor="center right"
                self="center left"
                >The number of pixels for border detection in Canvas.</q-tooltip
              ></span
            >
          </q-item-label>
        </q-item-section>
          ...
          <q-item-label>
            <span
              >Actions / Video segments<q-tooltip
                anchor="center right"
                self="center left"
                >Whether to show Actions / Video segments mode or not.</q-tooltip
              ></span
            >
          </q-item-label>
        </q-item-section>
          ...
          <q-item-label>
            <span
              >Show Popup<q-tooltip
                anchor="center right"
                self="center left"
                >Whether to show popup edit menu when creating annotations on canvas.</q-tooltip
              ></span
            >
          </q-item-label>
        </q-item-section>
