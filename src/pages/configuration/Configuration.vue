...
const handleLoad = () => {
  utils.confirm('Are you sure to load? This would override the configuration!').onOk(() => {
...
const handleSave = () => {
  utils.prompt('Save', 'Enter configuration filename for saving', 'config').onOk((filename) => {
